    ...
    <Master>
        <section class="py-5" style="min-height: 472px">
            <div class="container">
                <div class="row py-3">
                    <div class="col-12">
                        <p class="text-black-50">category by <span class="text-black fw-bold">"{{ category.name }}"</span></p>
                    </div>
                </div>
                <div class="row">
                    <h1 v-if="!products.length">There is no products category by <span>"{{ category.name }}"</span></h1>
                    <div
                        v-else
    ...
    computed: {
        ...
        products() {
            return this.$store.state.products.filter(
                (product) =>
                    product.category.slug === this.$route.params.category
            );
        },
    },
    methods: {
